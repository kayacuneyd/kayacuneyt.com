...
function renderHead($page, $postTitle = '', $postDescription = '', $postImage = '')
{
    ...
    $image = isset($seoData[$page]) ? $seoData[$page]['image'] : 'https://kayacuneyt.com/assets/images/laci-arkaplan.jpg';
    ...
    <html lang="en">
    <head>
        <script async src="https://www.googletagmanager.com/gtag/js?id=G-7MP2W78NLM"></script>
        <script>
          window.dataLayer = window.dataLayer || [];
          function gtag(){dataLayer.push(arguments);}
          gtag("js", new Date());
          gtag("config", "G-7MP2W78NLM");
        </script>
        <meta charset="UTF-8">
